...
# Based on all of the bootstrapped mean differences, the lowest was Bush
# followed by Walker and Cruz with the highest difference. Based on all 
# the results none of them contained 0 within their 95% confidence intervals
# So it is safe to say that there is a meaningful difference between all
# of the means. With Trump having the highest readability when compared to
# Walker, Cruz, and Bush.